...
var app = (function () {
    ...
    // (26:4) {#each posts as post}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*post*/ ctx[4].title + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*posts*/ 2 && t_value !== (t_value = /*post*/ ctx[4].title + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(26:4) {#each posts as post}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 22, 2, 641);
    			attr_dev(ul, "class", "svelte-1ogxns0");
    			add_location(ul, file, 24, 2, 694);
    			attr_dev(main, "class", "svelte-1ogxns0");
    			add_location(main, file, 21, 0, 631);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const isPosts = data => {
    		...
    		return ((_a = data[0]) === null || _a === void 0
    		? void 0
    		: _a.id) !== undefined || ((_b = data[0]) === null || _b === void 0
    		? void 0
    		: _b.title) !== undefined || Array.isArray(data) && data.length === 0; // data is an empty array
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$searchQuery*/ 1) {
    			{
    				r("show_posts", { filterTitle: $searchQuery }).then(res => {
    					if (isPosts(res)) {
    						$$invalidate(1, posts = res);
    					}
    				});
    			}
    		}
    	...
    	return [$searchQuery, posts, input_input_handler];
    }
